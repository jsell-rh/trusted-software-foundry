...
// All trusted components live in github.com/jsell-rh/trusted-software-components, so there
...
require github.com/jsell-rh/trusted-software-components v0.0.0
{{ if .RhtexAIPath }}
replace github.com/jsell-rh/trusted-software-components => {{ .RhtexAIPath }}
{{ end }}`))
