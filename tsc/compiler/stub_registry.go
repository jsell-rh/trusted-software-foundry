...
var knownComponents = map[string]*RegistryEntry{
	...
	"tsc-auth-jwt": {
		Name:      "tsc-auth-jwt",
		Version:   "v1.0.0",
		Module:    "github.com/openshift-online/tsc-components/auth/jwt",
		AuditHash: "stub-not-verified",
	},
	"tsc-grpc": {
		Name:      "tsc-grpc",
		Version:   "v1.0.0",
		Module:    "github.com/openshift-online/tsc-components/grpc",
		AuditHash: "stub-not-verified",
	},
	"tsc-health": {
		Name:      "tsc-health",
		Version:   "v1.0.0",
		Module:    "github.com/openshift-online/tsc-components/health",
		AuditHash: "stub-not-verified",
	},
	"tsc-metrics": {
		Name:      "tsc-metrics",
		Version:   "v1.0.0",
		Module:    "github.com/openshift-online/tsc-components/metrics",
		AuditHash: "stub-not-verified",
	},
	"tsc-events": {
		Name:      "tsc-events",
		Version:   "v1.0.0",
		Module:    "github.com/openshift-online/tsc-components/events",
		AuditHash: "stub-not-verified",
	},
}
