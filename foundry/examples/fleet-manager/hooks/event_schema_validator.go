...
// EventSchemaValidatorPrePublish ensures every outbound event has required envelope fields
...
func EventSchemaValidatorPrePublish(hctx *foundry.HookContext, msg *foundry.EventMessage) error {
	if msg.Topic == "" {
